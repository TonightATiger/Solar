...
def parse_args():
    ...
    parser.add_argument('--config',
                        # default=r'D:\liushuo\DAIMA\mmclassification-master\work-dir\mbv2\cls-test-0315\my_cls_mobilenet_v2_b32x8_batterycell.py',
                        default=r'D:\LSTEST\openMMLab\DCP-AIXU\DAIMA\YLClassifier\work-dir\resnet_4class_YL\cls-test-0414\my_resnet18_b32x8_batterycell.py',
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        #default=r'D:\liushuo\DAIMA\mmclassification-master\work-dir\resnet_6class\cls-test-0317\best_accuracy_top-1_epoch_50_6Class_0317_95.1.pth',
                        default=r'D:\LSTEST\openMMLab\DCP-AIXU\DAIMA\YLClassifier\work-dir\resnet_4class_YL\cls-test-0414\epoch_44.pth',
    ...
    parser.add_argument('--output-file',
                        type=str,
                        default=r'D:\LSTEST\openMMLab\DCP-AIXU\DAIMA\YLClassifier\work-dir\resnet_4class_YL\cls-test-0414\epoch_44.pt')
    parser.add_argument(
        '--shape',
        type=int,
        nargs='+',
