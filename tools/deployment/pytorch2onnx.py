...
def pytorch2onnx(model,
   ...
   # model.forward = partial(model.forward, img_metas={}, return_loss=False)
    ...
    with torch.no_grad():
        torch.onnx.export(
            model, (img_list,False, dict(rescale=True)),
            output_file,
            input_names=['input'],
            output_names=['output'],    # probs
            export_params=True,
...
def parse_args():
    ...
    parser.add_argument('--output-file', type=str, default=r'D:\LSTEST\openMMLab\DCP-AIXU\DAIMA\YLClassifier\work-dir\resnet_4class_YL\cls-test-0414\epoch_44.onnx')
