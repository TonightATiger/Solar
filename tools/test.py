...
def parse_args():
    ...
    parser.add_argument('--config',
                        default=r'E:\mmclassification-master\configs\resnet\my_resnet18_b32x8_batterycell.py',
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default=r'E:\mmclassification-master\work-dir\resnet18-0228\epoch_472.pth',
